...
> **Archival note:** These commands and Solidity harnesses target the original Uniswap V3 Core repository layout and API. They are preserved as upstream audit material and are not a runnable Tapir test guide. Links below point to the copies relocated into this directory.
